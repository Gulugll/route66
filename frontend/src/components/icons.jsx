...
//    SVG 的 currentColor 取 CSS 的 color 值:颜色由使用位置决定,
//    同一个图标在不同背景上自动适配,不与具体色值耦合。
//
// 2) 统一走一个 <Icon name="..."> 分发器。
//    调用方写 <Icon name="car" />,无需记住具体组件名。
//    代价是所有图标都会被打进产物(无法 tree-shaking)——
//    十几个图标的量级可忽略;达到几百个时应改为直接 import 具体组件。
